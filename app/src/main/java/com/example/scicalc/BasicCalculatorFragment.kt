...
class BasicCalculatorFragment : Fragment(R.layout.fragment_basic_calculator) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        numberIds.forEach { (id, label) ->
            view.findViewById<Button>(id).setOnClickListener { appendToken(label) }
        }
